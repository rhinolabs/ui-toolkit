    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-12">
      ...
      <Card className="p-8 hover:shadow-lg transition-shadow border-2 group">
        <div className="flex flex-col h-full">
          ...
          <p className="text-muted-foreground mb-6 flex-grow">
            A comprehensive set of 30+ UI components built with React and Tailwind CSS. 
            From buttons to complex data tables, our UI library has everything you need 
      ...
      <Card className="p-8 hover:shadow-lg transition-shadow border-2 group">
        <div className="flex flex-col h-full">
          ...
          <p className="text-muted-foreground mb-6 flex-grow">
            A collection of 30+ production-ready React hooks that solve common web 
            development challenges. These hooks help you manage state, handle side 
            effects, and implement complex functionality with ease.
          </p>
