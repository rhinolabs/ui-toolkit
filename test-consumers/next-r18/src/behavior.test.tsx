...
describe("Component behavior tests", () => {
  ...
  // 18. Toaster shows toast notification
  describe("Toaster", () => {
    it("displays a toast when triggered", async () => {
      function ThemeWrapper({ children }: { children: React.ReactNode }) {
        return React.createElement(ThemeProvider, { attribute: "class", defaultTheme: "light", enableSystem: false }, children);
      }

      render(React.createElement(Components.Toaster), { wrapper: ThemeWrapper });
